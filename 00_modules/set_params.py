...
class Models:
    ...
    def get_IPSL(cls):
        return cls(name='IPSL-CM6-ESMCO2', 
                   ...
                   down2K_start_year=2009, #stab2K_start_year+50,
                   stab4K_start_year=2082,
                   down4K_start_year=2132, #stab4K_start_year+50,
    ...
    def get_NorESM(cls):
        return cls(name='NorESM2-LM', 
                        ...
                        down4K_start_year=2107, #stab4K_start_year+50,
    ...
    def get_GFDL(cls):
        return cls(name='GFDL-ESM2M', 
                        ...
                        down2K_start_year=2008, #stab2K_start_year+50,
                        stab4K_start_year=2064,
                        down4K_start_year=2114, #stab4K_start_year+50,
    ...
    def get_UKESM(cls):
        return cls(name='UKESM1-2', 
                        ...
                        down2K_start_year=1994, #stab2K_start_year+50,
                        stab4K_start_year=2044, #2100,#1850,
                        down4K_start_year=2095, #stab4K_start_year+51, # starts in 2095 instead of 2094
    ...
    def get_NASA(cls):
        return cls(name='GISSE2.1-G-CC2',#'NASA-GISS-E2-1-G', 
                        ...
                        down4K_start_year=2177, #stab4K_start_year+50,
    ...
    def get_MIROC(cls):
        return cls(name='MIROC-ES2L',#'NASA-GISS-E2-1-G', 
                        ...
                        down2K_start_year=2150, #stab2K_start_year+50,
                        stab4K_start_year=2215,
                        down4K_start_year=2265, #stab4K_start_year+50,
    ...
    def get_CESM(cls):
        return cls(name='CESM2',#'NASA-GISS-E2-1-G', 
                        ...
                        down4K_start_year=281, #stab4K_start_year+50,
    ...
    def get_ACCESS(cls):
        return cls(name='ACCESS-ESM1-5',
                        ...
                        down2K_start_year=244, #stab2K_start_year+50,
                        stab4K_start_year=282,
                        down4K_start_year=332, #stab4K_start_year+50,
